...
<body>
        ...
        <article class='fy'>
            ...
            <?php if (empty($posts)): ?>
                <section class="no-posts">
                    <p class='no-posts-msg'>Não há posts disponíveis no momento. Adicione o primeiro clicando <a href="post.php" class='aqui'>aqui</a>!
                    </p>
                </section>
            <?php else: ?>
    ...
    <?php $autor = $post->getAutor(); ?>
            ...
            <div class='post-header'>
                <a href="profile.php?id=<?= $autor->getIdUsuario(); ?>">
    ...
    <a href="comments.php?idPost=<?= $post->getIdPost(); ?>" class="comment-btn">
        <img src="images/comment.png" alt="comment" class='commentpost'>
            ...
            <div class='posticon'>
                <a href="post.php"><img src="images/addpost.png" alt="" class='newpost'></a>
            </div>
        </main> 
    </div>
