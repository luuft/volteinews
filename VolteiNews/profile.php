...
try {
    $usuario = Usuario::find($idUsuarioPerfil);
} catch (Exception $e) {
...
$posts = Post::allMy($idUsuarioPerfil);
$isMe = $idUsuarioPerfil === $_SESSION['idUsuario'];
...
<body>
    ...
    <a href="like.php?idPost=<?= $post->getIdPost(); ?>" class="like-btn">
        <img src="images/<?= $post->isLikedBy($_SESSION['idUsuario']) ? 'liked.png' : 'like.png' ?>" alt="like" class='likepost'>
